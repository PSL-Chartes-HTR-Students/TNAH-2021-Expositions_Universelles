...
\title{WWWWWWWWWWWWWWWWWWWWWWWWWWWW}
...
\addbibresource{WWWWWWWWWWWWWWWWWWWWWWWW}
\nocite{*}
...
\usepackage{hyperref}
\hypersetup{pdfauthor={Baudoin DAVOURY}{Anahi HAEDO}{Paul KERVEGAN}{Kelly CHRISTENSEN}{Esteban SANCHEZ-OECONOMO}, pdftitle={WWWWWWWWWWWWWWWWWWWW}, pdfsubject={Projet Git sur les expositions universelles}, pdfkeywords={git}{expositions universelles}{tnah}}
